...
class TestResponseEmbeddedAngebotAnbieterAdresseOrtStrasseKoordinaten(
    unittest.TestCase
):
    """ResponseEmbeddedAngebotAnbieterAdresseOrtStrasseKoordinaten unit test stubs"""
    ...
    def testResponseEmbeddedAngebotAnbieterAdresseOrtStrasseKoordinaten(self):
        """Test ResponseEmbeddedAngebotAnbieterAdresseOrtStrasseKoordinaten"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedAngebotAnbieterAdresseOrtStrasseKoordinaten()  # noqa: E501
        pass
