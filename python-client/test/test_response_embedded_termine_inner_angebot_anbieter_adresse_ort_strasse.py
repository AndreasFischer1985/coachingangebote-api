...
class TestResponseEmbeddedTermineInnerAngebotAnbieterAdresseOrtStrasse(
    unittest.TestCase
):
    """ResponseEmbeddedTermineInnerAngebotAnbieterAdresseOrtStrasse unit test stubs"""
    ...
    def testResponseEmbeddedTermineInnerAngebotAnbieterAdresseOrtStrasse(self):
        """Test ResponseEmbeddedTermineInnerAngebotAnbieterAdresseOrtStrasse"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ResponseEmbeddedTermineInnerAngebotAnbieterAdresseOrtStrasse()  # noqa: E501
        pass
