...
class ResponseEmbeddedTermineInnerAngebotZertifiziererInner(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResponseEmbeddedTermineInnerAngebotZertifiziererInner - a model defined in OpenAPI
