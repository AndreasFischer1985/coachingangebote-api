...
class ResponseEmbeddedTermineInnerAngebotAnbieterAdresseOrtStrasseKoordinaten(
    ModelNormal
):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResponseEmbeddedTermineInnerAngebotAnbieterAdresseOrtStrasseKoordinaten - a model defined in OpenAPI
