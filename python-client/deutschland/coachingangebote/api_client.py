...
from deutschland.coachingangebote import rest
...
from deutschland.coachingangebote.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.aktivierungsangebote  # this is an instance of the class Endpoint
        api_instance.aktivierungsangebote()  # this invokes api_instance.aktivierungsangebote.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.aktivierungsangebote.callable or self.callable in this class
